...
data class Pose(
    ...
    companion object {
        ...
        val HATCH_HANDOFF = Pose(4.inches, (-20).degrees, 97.degrees, false, false)
        val HATCH_CARRY = Pose(7.inches, (-69).degrees, 1.degrees, false, false)
        val HATCH_LOW = Pose(0.inches, (-24).degrees, 6.degrees, false)
        val HATCH_MED = Pose(4.2.inches, 19.degrees, 6.degrees, false)
