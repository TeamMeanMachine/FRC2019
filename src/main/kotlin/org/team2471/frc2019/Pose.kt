...
data class Pose(val elevatorHeight: Length, val armAngle: Angle) {
    ...
    companion object {
        ...
        val HATCH_MED = Pose((.2).inches, 5.degrees) //21.5
        val HATCH_HIGH = Pose(12.inches, 28.degrees) //5
...
//        val CLIMB_START2 = Pose(1.inches, 18.degrees, 50.degrees, false, true,  true)
        ...
        val LIFTED2 = Pose((-19.5).inches, 65.degrees) //21.5 values need to be changed
...
//        val CLIMB_LIFT_ELEVATOR = Pose(0.inches, -17.5.degrees, 30.degrees, false, true, true)
        ...
        val CARGO_MED = Pose(1.inches, (25).degrees)
        val CARGO_HIGH = Pose(18.inches, (52).degrees)
        val CARGO_SHIP_SCORE = Pose((-6.5).inches, (17).degrees)
    }
}
